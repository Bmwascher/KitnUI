...
-- The accent the alternate artwork is built around. KITN_PINK stays the brand
-- colour rather than following it, because the Nameplates page reads that one and
-- an arrow colour is not artwork.
